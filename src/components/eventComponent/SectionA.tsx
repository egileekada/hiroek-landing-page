...
export default function SectionA() {
    return ( 
        <div className=' pb-24 lg:pb-28 pt-36 w-full text-left px-6 lg:px-14 flex relative gap-4 flex-col text-secondary ' >
            <p className=' text-3xl lg:text-[72px] lg:leading-[84px] max-w-[1187px] relative z-10 ' >Elevate Your Events, Connect with Your Audience, and Make a Lasting Impact</p>
