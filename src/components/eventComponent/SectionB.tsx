...
export default function SectionB() {
    return ( 
        <div style={{boxShadow: "0px -15px 30px 0px #37137F26"}} className=' py-20 w-full px-6 flex flex-col items-center gap-4 font-bold relative z-10 bg-secondary text-primary ' >
            <p className=" text-3xl lg:text-[80px] lg:leading-[84px] relative z-10 " >HOW TO GET STARTED</p>
            <p className=' text-lg lg:text-2xl lg:max-w[485px] text-center relative z-10' >Create your event profile and start connecting with your audience. <br/> For any questions or additional information, feel free to reach out to us at [ADD SUPPORT EMAIL].</p>
