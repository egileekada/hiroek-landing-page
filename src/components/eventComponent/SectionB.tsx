...
export default function SectionB() {
    ...
    return ( 
        <div style={{boxShadow: "0px -15px 30px 0px #37137F26"}} className=' py-20 w-full px-6 flex flex-col items-center gap-4 font-bold relative z-10 bg-secondary text-primary ' >
            ...
            <div className=' text-lg lg:text-3xl lg:max-w-[885px] text-center relative z-10' >For questions or additional information, on how to become a partner, feel free to get in touch <GetInTouch span={true} text="info@hiroek.io" open={open} setOpen={setOpen} /></div>
