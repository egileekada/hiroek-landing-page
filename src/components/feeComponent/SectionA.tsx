    ...
    return (
        <div className=' pb-24 lg:pb-32 px-6 pt-40 lg:pt-48 gap-5 flex flex-col w-full text-center items-center text-white relative ' >
            ...
            <div className=" flex flex-col gap-2 " >
                ...
                <p className=" text-lg lg:text-[24px] lg:leading-[120%] font-axiformamedium lg:font-axiformaheavy lg:max-w-[1282px] relative z-10 " >Stripe Fee: 1.5% + £0.20p per transaction</p>
                <p className=" text-lg lg:text-[24px] lg:leading-[120%] font-axiformamedium lg:font-axiformaheavy lg:max-w-[1282px] relative z-10 " >Hiroek Fee: £0.60p per ticket</p>
