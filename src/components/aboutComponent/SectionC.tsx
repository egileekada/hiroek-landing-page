...
export default function SectionC() {
    return (
        <div className=' py-20 text-[#F0F2FF] px-12 flex w-full gap-3 items-center flex-col ' >
            <p className=' text-[38px] leading-[57px] font-black text-center max-w-[1115px] ' >Giving has long been underrated and underserved, so we're developing technology that makes a difference. Elevate your fundraising efforts and sign up now.</p>
