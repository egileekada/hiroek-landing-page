...
export default function SectionC() {
    return (
        <div className=' py-20 text-[#F0F2FF] px-12 flex w-full gap-3 items-center flex-col ' >
            <p className=' text-[38px] leading-[57px] font-axiformamedium text-center max-w-[1115px] ' >Our mission is to empower you via our technology and innovation to seamlessly involve your community in your efforts to raise awareness for your cause and create a positive impact.</p>
