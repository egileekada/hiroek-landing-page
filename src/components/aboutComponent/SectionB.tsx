...
export default function SectionB() {
    return (
        <div className=' w-full py-14 flex lg:flex-row flex-col relative lg:gap-0 gap-6 items-center px-6 lg:px-12 bg-[#F0F2FF] justify-center text-[#37137F] ' >
            ...
            <div className="  font-medium lg:text-[26px] relative z-10 lg:leading-[39px] flex flex-col gap-4  " >
                {/* <p className="text-3xl lg:text-[40px] lg:leading-[50px] text-center " >Why Hiroek</p> */}
                <p className=" whitespace-pre-line font-axiformamedium " >{`
                ...
                A dedicated mobile platform making It easier for you to come together with your peers to support causes you care about. \n
                Empowering a new generation of philanthropists, supporters and action- takers (Uniting thinkers, carers and doers) \n
                A tool for grass root based organisation to create and expand their spaces to amplify the crucial role they play in advancing social well-being.  \n
