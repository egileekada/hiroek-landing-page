    ...
    return (
        <div className=" bg-[#F0F2FF] text-[#37137F] relative z-10 !font-bold gap-10 w-full flex justify-center py-24 " >
            ...
            <div className=" max-w-[500px] flex flex-col gap-3 " >
                ...
                <p className=" text-2xl " >Hiroek makes inviting and connecting with your friends easy. Incorporated messaging and interaction features ensuring you remain connected to your existing network on and offline.</p>
