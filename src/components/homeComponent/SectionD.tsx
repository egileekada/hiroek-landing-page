    ...
    return (
        <div className=' text-[#F0F2FF] !font-bold gap-10 rounded-t-[#F0F2FF] w-full flex justify-center py-24  ' >
            <div className=' max-w-[508px] flex flex-col gap-3 ' >
                ...
                <p className=' text-2xl ' >Quickly connect with like-minded individuals and build your community without the usual complexities, allowing you to focus on what truly matters.</p>
