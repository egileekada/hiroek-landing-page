...
export default function NinethSection() {
    return (
        <div className=' py-20 w-full flex flex-col items-center gap-4 text-white ' >
            <p className=" text-[80px] leading-[84px] " >GOOD ON THE MOOOOVE!</p>
            <p className=' text-2xl max-w[485px] ' >Discover the unique features of Hiroek. It's a community for good in your pocket</p>
