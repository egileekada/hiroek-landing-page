...
export default function EightSection() {
    ...
    return (
        <div className=" text-[#F0F2FF] bg-[#37137F] relative z-10 overflow-y-hidden lg:px-6 !font-bold gap-10 w-full flex flex-col lg:flex-row-reverse justify-center lg:items-start items-center pt-20  " >
            <div className=" lg:w-[518px] relative z-10 lg:mt-auto lg:h-full px-6 flex justify-center items-end  " >
                <img alt="one" src="/images/appmission.png" className=" mt-auto" />
            </div>
            <div className=" lg:max-w-[500px] lg:py-24  relative z-10 flex lg:px-0 px-6 bg-primary pt-4 lg:h-auto h-[300px] flex-col gap-3 " >
                ...
                <GetInTouch tab={2} open={open} label="Get Started" setOpen={setOpen} whitebg={true} activatebtn={true} coloredbtn />
            </div>
