...
export default function ThirdSection() {
    return (
        <div className=" bg-[#F0F2FF] text-[#37137F] !font-bold gap-10 rounded-t-3xl lg:rounded-t-[120px] w-full flex px-6 lg:flex-row flex-col justify-center pt-24 pb-20 " >
