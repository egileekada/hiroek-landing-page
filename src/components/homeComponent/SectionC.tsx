    ...
    return (
        <div className=" bg-[#F0F2FF] text-[#37137F] !font-bold gap-10 rounded-t-[120px] w-full flex justify-center pt-24 pb-20 " >
            ...
            <div className=" max-w-[544px] flex flex-col gap-3 " >
                ...
                <p className=" text-2xl text-[#424242] font-axiformamedium " >With Hiroek, planning and organising events is streamlined and intuitive, saving you valuable time and reducing the hassle of Event management.</p>
