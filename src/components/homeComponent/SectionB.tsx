    ...
    return (
        <div className=" w-full relative " > 
            <div className=' w-full px-6 relative z-20 lg:px-14 py-24 flex flex-col gap-4 lg:gap-2 bg-transparent font-bold text-[#F0F2FF] ' >
                <p className=' text-3xl xl:text-[56px] lg:text-[45px] xl:leading-[60px] lg:leading-[50px] lg:max-w-[800px] ' >Make your charitable fundraising impactful with Hiroek.</p>
